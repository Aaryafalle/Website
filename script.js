...
document.querySelectorAll("i.fa-ellipsis-vertical").forEach((el) => {
  el.addEventListener("click", (e) => {
    ...
    menu.innerHTML = `
        ...
        <li><i class="fa-solid fa-share ml-px md:ml-0"></i><button class="modal-share whitespace-pre truncate items-center flex justify-evenly gap-x-2" id="copy-link-btn">Copy Link <span class="text-[.5em] p-1 md:p-1.5 bg-gray-600/20 rounded overflow-x-scroll text-ellipsis rounded whitespace-pre inline-block w-[10rem] md:w-[15rem]">${encodeURIComponent(link)}</span></button></li>
      `;
